      ...
      <div className="intro-content">
        <div className="text-content">
          <p className="bio">
            ...
            <br />
            <br />
            I enjoy writing code as much as I enjoy meaningful conversations. I have developed skills in C, C++, MySQL, HTML, CSS, and React.JS, and I love using these tools to bring ideas to life. I have also actively participated in coding competitions such as the ACM Speed Programming Competition and the SOFTEC SQL Query Master, which have sharpened my problem-solving abilities and exposed me to fast-paced, real-world challenges.
            <br />
            <br />
            Outside the academic and competitive space, I am drawn to storytelling and photography, which allow me to express creativity, capture unique perspectives, and connect with others on a deeper level. I believe in continuous self-discovery and in pushing my boundaries to better understand both myself and the world around me.
            <br />
            <br />
        ...
        <div className="ppm-container">
          ...
          <a href="https://linktr.ee/abdullahpatti?utm_source=linktree_profile_share&ltsid=f18c952d-332f-4d07-a1d2-110b51c2f023" target="_blank" rel="noopener noreferrer" className="ppm-button">
            LinkTree
          </a>
        </div>
      </div>
